...
Blackjack agent combining tabular Q-learning and DQN with card counting and a regression-based betting agent. Achieves +1.43% profit over the house edge using card counting and dynamic bet sizing. Built with Python & PyTorch.
